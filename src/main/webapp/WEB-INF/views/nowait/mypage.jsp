...
<header>
	...
	<nav>
		<ul class="nav-1">
					<li class="nav-item1"> <c:if test="${nowait != null}">
	...
	<nav>
	   ...
	   <article class="container">
            ...
            <div class="col-sm-6 col-md-offset-3">
                <form action="/nowait/mypage" method="post" role="form" autocomplete="off">
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="cust_birth" value="${nowait.cust_birth}" readonly>          
                    </div>
                    
                    <div class="form-group">
                        <label for="cust_email">이메일 주소</label>
                        <input type="email" class="form-control" name="cust_email" value="${nowait.cust_email}">
                    </div>
                    
             
                    <div class="form-group">
                        <label for="cust_pn">휴대폰 번호</label>
                        <input type="tel" class="form-control"name="cust_pn" value="${nowait.cust_pn}">
                    </div>
                    <div class="form-group">    
