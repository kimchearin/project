            ...
            <div class="col-sm-6 col-md-offset-3">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="cust_pw2" placeholder="Confirm Password">
                       ...
                       <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="cust_birth" name="cust_birth" placeholder="ex) 19990101">
                       <div class="eheck_font" id="birth_check"></div>
                    </div>
                    
                    <div class="form-group">
                        <label for="cust_email">이메일 주소</label>
                        <input type="email" class="form-control" id="cust_email" name="cust_email" placeholder="E-mail">
                       <div class="eheck_font" id="email_check"></div>
                    </div>
                    
             
                    <div class="form-group">
                        <label for="cust_pn">휴대폰 번호('-'없이 번호만 입력해주세요)</label>
                        <input type="tel" class="form-control" id="cust_pn" name="cust_pn" placeholder="Phone Number">
...
<input class="form-control" style="width: 40%; display: inline;" placeholder="우편번호" name="cust_oaddr" id="cust_oaddr" type="text" readonly="readonly" >
    <button type="button" class="btn btn-default" onclick="execPostCode();"><i class="fa fa-search"></i> 우편번호 찾기</button>                               
</div>

<div class="form-group">
    <input class="form-control" style="top: 5px;" placeholder="도로명 주소" name="cust_addr" id="cust_addr" type="text" readonly="readonly" />
</div>

<div class="form-group">
    <input class="form-control" placeholder="상세주소" name="cust_detailaddr" id="cust_detailaddr" type="text"  />
</div>
